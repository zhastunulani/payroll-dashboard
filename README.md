...
| URL | Мақсаты |
|---|---|
| `/` | Барлық жобаның қаржылық шолуы: KPI, жоба карточкалары, 6 айлық динамика, P&L матрицасы, деректер сапасы |
| `/finance` | Бір жобаның P&L-і: санаттар, ФОТ бөлімдер бойынша, таргет воронкасы, юнит-экономика, реестр |
